...
locale.ru = {
    ...
    faqEditA: 'Откройте ее и обратите внимание на две иконки в правом верхнем углу описания. Иконка с карандашом открывает редактирование, а мусорная корзина удаляет колоду.',
